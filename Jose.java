...
class BukuIT {
  ...
  void method3() {
    ...
    System.out.println(
        "2. Structure and Interpretation of Computer Programs, 1992, Harold Abelson, Gerald Jay Sussman, Julie Sussman");
    ...
    System.out.println(
        "5. Introduction to Algorithms 1889, Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, Clifford Stein");
    ...
    System.out.println(
        "8. The Self-Taught Programmer: The Definitive Guide to Programming Professionally, 2005, Cory Althoff");
...
class BukuPsikologi {
  ...
  void method5() {
    ...
    System.out.println(
        "2. Warna-Warni Psikologi Untuk Negeri: Pemikiran Dan Aplikasinya, 2000, Tim Pengajar Fakultas Psikologi Universitas Yarsi.");
...
class BukuPolitik {
  ...
  void method6() {
    ...
    System.out.println(
        "5. Politik Sirkulasi Budaya Pop: Media Baru, Pelintiran Agama, dan Pergeseran Otoritas , 2019, Wahyudi Akmaliah");
    System.out
        .println("6. Ada Apa dengan China: Esai-Esai Agama dan Politik China untuk Indonesia, 2019, Novi Basuki\n\n");
    Scanner keyboard = new Scanner(System.in);
    System.out.print("Masukan Nama Buku: ");
    masukan = keyboard.nextLine();
    System.out.println(masukan);
...
public class Jose {
  public static void Jose(String[] args) {
    Dosen dosen1 = new Dosen();
    Mahasiswa Jose = new Mahasiswa();
    pengembalian cetak = new pengembalian();
    Pembuka print = new Pembuka("Peminjaman Buku Perpustakaan");
    penutup salam = new penutup("Terimakasih atas kunjungan anda");
